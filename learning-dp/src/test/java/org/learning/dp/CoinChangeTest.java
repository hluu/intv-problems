...
public class CoinChangeTest {
	...
	public void oneElementTest() {
		int[] denominations = {2};
		Assert.assertEquals(CoinChange.coinChange(1, denominations), -1);
	}

	@Test()
	public void oneElementTest2() {
		int[] denominations = {2};
		Assert.assertEquals(CoinChange.coinChange(2, denominations), 1);
	}

	@Test()
	public void basicTest() {
		int[] denominations = {1,3,4};
		Assert.assertEquals(CoinChange.coinChange(6, denominations), 2);
	}
	...
	public void zeroAmountTest() {
		int[] denominations = {1,3,5};
		Assert.assertEquals(CoinChange.coinChange(0, denominations), -1);
	}

	@Test(enabled = false)
	public void anotherLargeAmountTest() {
		int[] denominations = {186,419,83,408};
		Assert.assertEquals(CoinChange.coinChange(6249, denominations), 20);
	}
}
